...
# the documentation of BOOST_FIND_LIB above.
AC_DEFUN([BOOST_MPI],
boost_mpi_save_LIBS=$LIBS
boost_mpi_save_LDFLAGS=$LDFLAGS
LIBS="$LIBS $BOOST_SERIALIZATION_LIBS"
LDFLAGS="$LDFLAGS $BOOST_SERIALIZATION_LDFLAGS"
[BOOST_FIND_LIB([mpi], [$1],
                [boost/mpi.hpp],
                [boost::mpi::communicator world;])
LIBS=$boost_mpi_save_LIBS
LDFLAGS=$boost_mpi_save_LDFLAGS
])# BOOST_MPI
...
if test x$boost_cv_inc_path != xno; then
  ...
  for i in \
    ...
    "defined __ICL @ iw" \
    "defined __xlC__ && __xlC__ == 0x900 @ xlc90" \
    "defined __xlC__ && __xlC__ == 0x01010 @ xlc101" \
    "defined __xlC__ && __xlC__ == 0x0b01 @ xlc111" \
